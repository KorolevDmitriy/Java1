...
public class TicTacToe {
    ...
    private static final String PLAYER_WIN_MESSAGE = "Пользовательн победил!";
    private static final String AI_WIN_MESSAGE = "Поедил Искуственный Интеллект!";
    ...
    private static void setCell(int rowIndex, int colIndex, char symbol) {
        ...
        @SuppressWarnings("SamePerameterValue")
